...
public static class OSCMapping {
	...
	//Forest Related
	public const string WEATHER_SUN = "/weather-sun";
	public const string WEATHER_RAIN = "/weather-rain";
	public const string WEATHER_FOG = "/weather-fog";
	public const string WEATHER_CLOUDS = "/weather-clouds";
